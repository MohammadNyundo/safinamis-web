class CustomNavbar extends HTMLElement {
    ...
    render() {
        // Create shadow DOM instead of using innerHTML directly
    ...
    initEventListeners() {
        ...
        if (mobileMenu && navLinks) {
            ...
            document.addEventListener('click', (e) => {
                if (this.isMobileMenuOpen && !this.shadowRoot.contains(e.target)) {
                    this.closeMobileMenu();
                }
            });
    ...
    openMobileMenu() {
        const navLinks = this.shadowRoot.querySelector('#navLinks');
        const mobileMenuIcon = this.shadowRoot.querySelector('.mobile-menu-icon');
        const mobileMenu = this.shadowRoot.querySelector('#mobileMenu');
